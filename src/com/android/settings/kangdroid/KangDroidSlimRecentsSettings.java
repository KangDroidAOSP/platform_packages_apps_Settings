...
import com.android.settings.kangdroid.KangDroidRecentsSettings;

import com.android.internal.util.slim.DeviceUtils;

import net.margaritov.preference.colorpicker.ColorPickerPreference;

public class KangDroidSlimRecentsSettings extends SettingsPreferenceFragment implements
    ...
    private static final String TAG = "KangDroidSlimRecentsSettings";
	...
	KangDroidRecentsSettings mDefaultKDPRecents;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.kangdroid_slim_recents_settings);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ContentResolver resolver = getActivity().getContentResolver();
       	if (preference == mUseSlimRecents) {
            ...
            mDefaultKDPRecents.updatePreference();
            return true;
    ...
    public void updateRecentPanelPreferencesForKDP() {
    ...
    public void initializeAllPreferencesForKDP() {
    ...
    public void updatePreference() {
		mDefaultKDPRecents = new KangDroidRecentsSettings();
        boolean slimRecent = Settings.System.getInt(getActivity().getContentResolver(),
                    Settings.System.USE_SLIM_RECENTS, 0) == 1;

        if (slimRecent) {
			mDefaultKDPRecents.disablePreferenceAndUpdate();
            initializeAllPreferencesForKDP();
            updateRecentPanelPreferencesForKDP();
        } else {
			mDefaultKDPRecents.enablePreferenceAndUpdate();
        }
    }
